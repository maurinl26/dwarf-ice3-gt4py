...
def mixing_ratio_step_limiter(
    ...
    Args:
        rc_0r_t (gtscript.Field[float]): _description_
        rr_0r_t (gtscript.Field[float]): _description_
        ri_0r_t (gtscript.Field[float]): _description_
        rs_0r_t (gtscript.Field[float]): _description_
        rg_0r_t (gtscript.Field[float]): _description_
        rc_t (gtscript.Field[float]): _description_
        rr_t (gtscript.Field[float]): _description_
        ri_t (gtscript.Field[float]): _description_
        rs_t (gtscript.Field[float]): _description_
        rg_t (gtscript.Field[float]): _description_
        rc_b (gtscript.Field[float]): _description_
        rr_b (gtscript.Field[float]): _description_
        ri_b (gtscript.Field[float]): _description_
        rs_b (gtscript.Field[float]): _description_
        rg_b (gtscript.Field[float]): _description_
        rc_a_tnd (gtscript.Field[float]): _description_
        rr_a_tnd (gtscript.Field[float]): _description_
        ri_a_tnd (gtscript.Field[float]): _description_
        rs_a_tnd (gtscript.Field[float]): _description_
        rg_a_tnd (gtscript.Field[float]): _description_
        delta_t_micro (gtscript.Field[float]): _description_
        time_threshold_tmp (gtscript.Field[float]): _description_
    """
